...
카메라 모듈을 장착한 라즈베리 파이 Zero kit 두 대를 각 각 내, 외부를 촬영하는 역할로 사용하였습니다. 내부는 어린아이 유,무를 확인하는 용도이며 외부는 운전대 기준으로 오른쪽 차량 사이드 미러에 설치하여 아이들의 승, 하차 할 때 보이지 않는 사각지대에서의 위험을 예방하기 위해 설치하였습니다.
